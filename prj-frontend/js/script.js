...
var lista;
var api = "https://prj-produtos-java.herokuapp.com/";
...
function listar() {
    ...
    xhttp.onload = function () {
        ...
        for (const u of lista) {
            texto += `<tr onclick='editar(${i})'><td>${u.nome}</td><td>${u.quantidade}</td><td>${u.email}</td></tr>`;
            i++;
        }
...
function editar(i) {
    ...
    document.getElementById("Quantidade").value = u.quantidade;
